...
type ConnectorServiceClient interface {
	...
	Connect(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ConnectorMessage, GatewayCommand], error)
}
...
func (c *connectorServiceClient) Connect(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ConnectorMessage, GatewayCommand], error) {
	...
	x := &grpc.GenericClientStream[ConnectorMessage, GatewayCommand]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ConnectorService_ConnectClient = grpc.BidiStreamingClient[ConnectorMessage, GatewayCommand]
...
type ConnectorServiceServer interface {
	// Connect establece stream bidireccional para el túnel reverso
	Connect(grpc.BidiStreamingServer[ConnectorMessage, GatewayCommand]) error
...
func (UnimplementedConnectorServiceServer) Connect(grpc.BidiStreamingServer[ConnectorMessage, GatewayCommand]) error {
...
func _ConnectorService_Connect_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ConnectorServiceServer).Connect(&grpc.GenericServerStream[ConnectorMessage, GatewayCommand]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ConnectorService_ConnectServer = grpc.BidiStreamingServer[ConnectorMessage, GatewayCommand]
